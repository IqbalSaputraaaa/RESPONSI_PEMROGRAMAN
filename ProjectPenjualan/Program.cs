...
namespace ProjectPenjualan
{
    class Program
    {
        ...
        static void TambahPenjualan()
        {
            ...
            Penjualan pjl = new Penjualan(nota, tgl, cust, jenis, totalNota);
        ...
        static void TampilPenjualan()
        {
            ...
            foreach (Penjualan pjl in daftarPenjualan)
            {
                Console.WriteLine("{0}. {1}, {2}, {3}, {4}, {5}", i, pjl.Nota, pjl.Tanggal, pjl.Cust, pjl.Jenis, pjl.TotalNota);
                i++;
            }
